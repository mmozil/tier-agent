...
async def handle_inbound_message(
    ...
    *,
    ...
    _base = (
        ...
        "nem ocupa a agenda do profissional. Cobra-se por FAIXA de distância — calcule pelo CEP "
        "(pet_taxidog_cotar) e some só o PREÇO da faixa. A busca é ANTES do horário e a entrega DEPOIS; "
        "NUNCA invente uma janela exata de minutos nem diga que 'o atendimento aumentou' por causa do Taxidog.\n"
