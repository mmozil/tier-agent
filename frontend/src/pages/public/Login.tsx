...
export default function Login() {
  ...
  const loginWithGoogle = useGoogleLogin({
    flow: "implicit",
    onSuccess: async () => {
      // useGoogleLogin com flow implicit retorna access_token, mas pra ID token
      // (que validamos no backend) precisamos do One Tap ou flow auth-code.
      // Fluxo simples: tokenResponse.access_token + chamar Google userinfo no backend.
      toast.error("Configure One Tap pra ID token completo");
    },
  ...
  // One Tap renderiza botão Google nativo + retorna ID token
  // Aqui o handler está conectado quando user clica
  void loginWithGoogle; // suppress unused (mantido pra futuro flow alternativo)
