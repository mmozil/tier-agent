  ...
  return (
    <div className="-mx-8 pb-10">
      <PageFrame>
        <Row>
          <div className="p-6">
            <h2 className={`text-[20px] font-[500] fc-crisp tracking-[-0.1px] leading-7 ${FC.ink}`}>Configurações</h2>
            <p className={`text-[13px] leading-5 mt-1 ${FC.dim}`}>Tudo que controla o comportamento dos seus agentes.</p>
          </div>
        </Row>
